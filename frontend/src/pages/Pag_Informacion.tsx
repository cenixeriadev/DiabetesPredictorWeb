...
import videoDiabetes from "../assets/videos/diabetesvideo1.mp4";
import videoMonitoreo from "../assets/videos/diabetesvideo2.mp4";
    ...
    <>
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p className="hero-description">
              ...
              utiliza eficazmente la insulina que produce. Conoce más sobre esta
              condición y cómo manejarla adecuadamente.
            </p>
          </div>
          <div className="hero-media">
            <video width="100%" height="auto" controls>
              <source src={videoDiabetes} type="video/mp4" />
        ...
        <div className="container">
          ...
          <div className="content-row">
            <div className="text-content">
              <p>
                Los síntomas de la diabetes pueden desarrollarse gradualmente y
                a menudo pasan desapercibidos. Es importante conocer las señales
                de alerta para buscar atención médica oportuna.
              </p>
          ...
          <div className="types-grid">
            <div className="type-card">
              ...
              <div className="card-content">
                ...
                <p>
                  Condición autoinmune donde el cuerpo no produce insulina.
                  Generalmente se desarrolla en la infancia o adolescencia.
                </p>
              </div>
            </div>
            <div className="type-card">
              ...
              <div className="card-content">
                ...
                <p>
                  El cuerpo no usa la insulina eficientemente. Es la forma más
                  común y está relacionada con el estilo de vida.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="management-grid">
            <div className="management-item">
              ...
              <p>
                Una dieta balanceada es fundamental para controlar los niveles
                de azúcar en sangre.
              </p>
            </div>
            <div className="management-item">
              ...
              <p>
                El ejercicio regular ayuda a mejorar el control glucémico y la
                salud general.
              </p>
            </div>
            <div className="management-item">
              ...
              <p>
                Controlar regularmente los niveles de glucosa es esencial para
                un buen manejo.
              </p>
            </div>
          </div>
      ...
      <section className="tools-section">
        <div className="container">
          ...
          <div className="tools-video">
            <video className="video-pequeno" controls>
              <source src={videoMonitoreo} type="video/mp4" />
              Tu navegador no soporta el video.
            </video>
          </div>
          ...
          <div className="tools-content">
            <div className="tool-row">
              ...
              <div className="tool-info">
                ...
                <p>
                  Dispositivo portátil que mide la glucosa en sangre mediante
            ...
            <div className="tool-row reverse">
              <img
                src={imagen11}
                alt="Monitor continuo de glucosa"
                className="image-placeholder"
              />
              <div className="tool-info">
                <h3>Monitor continuo de glucosa</h3>
                <p>
                  Tecnología avanzada que proporciona lecturas continuas de
                  glucosa las 24 horas del día.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="medical-content">
            <div className="medical-text">
              ...
              <p>
                El seguimiento médico regular es fundamental para prevenir
                complicaciones y mantener una buena calidad de vida. Consulta
                con profesionales de la salud especializados en diabetes.
              </p>
              <div className="medical-points">
                <div className="point">
                  <strong>Endocrinólogo:</strong> Especialista en diabetes y
                  metabolismo
                </div>
                <div className="point">
                  <strong>Nutricionista:</strong> Planificación de dieta
                  personalizada
                </div>
                <div className="point">
                  <strong>Educador en diabetes:</strong> Enseñanza del manejo
                  diario
                </div>
              </div>
            </div>
