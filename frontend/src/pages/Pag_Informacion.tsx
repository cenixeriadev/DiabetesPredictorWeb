    ...
    <div className="tools-content">
      <div className="tool-row">
        ...
        <div className="tool-info">
          ...
          <p>
            Dispositivo portátil que mide la glucosa en sangre mediante una
      ...
      <div className="tool-row reverse">
        ...
        <div className="tool-info">
          ...
          <p>
            Tecnología avanzada que proporciona lecturas continuas de glucosa
        ...
        <div className="container">
            <div className="medical-content">
                <div className="medical-text">
                    <h2 className="section-title">Atencion medica personalizada</h2>
